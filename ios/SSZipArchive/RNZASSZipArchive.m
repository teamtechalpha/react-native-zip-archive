...
NSString *const RNSSZipArchiveErrorDomain;
typedef NS_ENUM(NSInteger, RNSSZipArchiveErrorCode) {
    RNSSZipArchiveErrorCodeFailedOpenZipFile      = -1,
    RNSSZipArchiveErrorCodeFailedOpenFileInZip    = -2,
    RNSSZipArchiveErrorCodeFileInfoNotLoadable    = -3,
    RNSSZipArchiveErrorCodeFileContentNotReadable = -4,
    RNSSZipArchiveErrorCodeFailedToWriteFile      = -5,
    RNSSZipArchiveErrorCodeInvalidArguments       = -6,
};
